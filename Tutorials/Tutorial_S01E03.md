...
<p>
<img alt="classroom" src="../images/classroom.jpg" width=100% height="250px"></img>
</p>
...
It has been said that another word to use for sections could be `group`. The reason behind a section is to group a ***section*** of rules together. As it currently stands rules are ran in order, within each section.
